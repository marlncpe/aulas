...
<div align="right">
    <?php echo $this->tag->linkTo(array('permisos/new', 'Create permisos')); ?>
</div>

<?php echo $this->tag->form(array('permisos/search', 'method' => 'post', 'autocomplete' => 'off')); ?>

<div align="center">
    <h1>Search permisos</h1>
</div>
