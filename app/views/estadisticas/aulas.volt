<div class="card">
                                ...
                                <div class="card-body card-padding">
                                    <div id="pie-chart" class="flot-chart-pie" style="padding: 0px; position: relative;"><canvas class="flot-base" width="178" height="300" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 178px; height: 300px;"></canvas><canvas class="flot-overlay" width="178" height="300" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 178px; height: 300px;"></canvas></div>
